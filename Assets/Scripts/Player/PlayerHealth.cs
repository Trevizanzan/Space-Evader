...
public class PlayerHealth : MonoBehaviour
{
    ...
    public void TakeDamage(int amount)
    {
        ...
        if (currentHealth <= 0)
        {
            ...
            return; // non avviare i-frames se � morto
        }

        // Avvia i-frames solo se � ancora vivo
        if (blinkCoroutine != null) StopCoroutine(blinkCoroutine);
        blinkCoroutine = StartCoroutine(InvulnerabilityRoutine());
    }

    /// <summary>
    /// I-frames (invincibility frames) � finestra di tempo dopo aver ricevuto un colpo durante la quale il giocatore � invulnerabile. 
    ...
    /// Il blink visivo comunica al giocatore che l'invulnerabilit� � attiva.
    /// </summary>
    public void AddLife()
    {
