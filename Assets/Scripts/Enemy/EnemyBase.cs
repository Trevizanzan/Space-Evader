...
public abstract class EnemyBase : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        destroyYBottom = -camHeight * 1.1f;     // Distruggi quando � un po' sotto la camera
        destroyXLimit = camWidth * 1.1f;    // Distruggi quando � un po' oltre i bordi laterali
    ...
    protected virtual void OnDamageFeedback()
    {
        ...
        // Base: nessuna esplosione, solo suono (gi� gestito in TakeDamage)
    ...
    /// <summary>
    /// Bounds della camera in world units, con offset topbar gi� sottratto da topY.
    /// </summary>
